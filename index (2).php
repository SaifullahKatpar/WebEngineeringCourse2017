...
<!-- Mirrored from html.physcode.com/travel/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 18:39:17 GMT -->
<head>
			...
			<div class="container">
				...
				<div class="width-logo sm-logo">
					<a href="#" title="Travel" rel="home">
						<img src="images/mylogo.png" alt="Logo" width="474" height="130" class="logo_transparent_static">
						<img src="images/mylogo.png" alt="Sticky logo" width="474" height="130" class="logo_sticky">
					</a>
				</div>
				<nav class="width-navigation">
					<ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
						<li class="current-menu-ancestor current-menu-parent">
							...
							<ul class="sub-menu">
								<li><a href="index-2.php">Home 1 – Video Slider</a></li>
								<li><a href="home-2.php">Home 2 – Image Slider</a></li>
								<li><a href="home-3.php">Home 3 – Background Image</a></li>
							...
							<ul>
								<li id="travel_social_widget-2" class="widget travel_search">
									...
									<div class="search-menu search-overlay search-hidden">
										<div class="closeicon"></div>
										<form method="get" class="search-form" action="http://php.physcode.com/travel/tours.php">
	...
	<div class="site wrapper-content">
		<div class="home-content" role="main">
			<div class="wrapper-bg-video">
				<video poster="gorakh.jpg" playsinline autoplay muted loop>
					<source src="video.mp4" type="video/mp4">
					<!--http://physcode.com/video/330149744.mp4-->
				</video>
				<div class="content-slider">
					<p>Explore Beauty </p>
					<h2> Explore Sindh</h2>
					<p><a href="tours.php" class="btn btn-slider"> Let's Plan </a></p>
				</div>
			</div>


<!--               this is the slider for searching for tours 

			<div class="slider-tour-booking">
				<div class="container">
					<div class="travel-booking-search hotel-booking-search travel-booking-style_1">
						<form name="hb-search-form" action="http://html.physcode.com/travel/tours.php" id="tourBookingForm">
			...
			<div class="padding-top-6x padding-bottom-6x section-background" style="background-image:url(images/home/suk2.jpg)">
				<div class="container">
									...
									<div class="item_content">
										<div class="post_images">
											...
											<span class="price"><del>
												...
												-->
												<img src="images/tour/sukkur.jpg" alt="" title="">
											</a>
...
<!-- Mirrored from html.physcode.com/travel/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 18:41:55 GMT -->
</html>