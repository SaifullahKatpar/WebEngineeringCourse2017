...
<!-- Mirrored from html.physcode.com/travel/single-tour.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 18:46:16 GMT -->
<head>
	...
	<link rel="stylesheet" href="localhost/temp1/assets/css/font-awesome.min.css" type="text/css" media="all">
	<link rel="stylesheet" href="localhost/temp1/assets/css/flaticon.css" type="text/css" media="all">
	<link rel="stylesheet" href="localhost/temp1/assets/css/font-linearicons.css" type="text/css" media="all">
	<link rel="stylesheet" href="localhost/temp1/assets/css/booking.css" type="text/css" media="all">
	<link rel="stylesheet" href="localhost/temp1/assets/css/swipebox.min.css" type="text/css" media="all">
	<link rel="stylesheet" href="localhost/temp1/style.css" type="text/css" media="all">
	<link rel="stylesheet" href="localhost/temp1/assets/css/travel-setting.css" type="text/css" media="all">
	<link rel="shortcut icon" href="localhost/temp1/images/favicon.png" type="image/x-icon">
</head>
...
<div class="wrapper-container">
		...
		<div class="navigation-menu">
			<div class="container">
				...
				<div class="width-logo sm-logo">
					<a href="localhost/temp1/index-2.php" title="Travel" rel="home">
						<img src="localhost/temp1/images/logo_sticky.png" alt="Logo" width="474" height="130" class="logo_transparent_static">
						<img src="localhost/temp1/images/logo_sticky.png" alt="Sticky logo" width="474" height="130" class="logo_sticky">
					</a>
				</div>
				<nav class="width-navigation">
					<ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
						...
						<li class="menu-item-has-children">
							<a href="localhost/temp1/tours.php">Tours</a>
							<ul class="sub-menu">
								<li class="current-menu-ancestor current-menu-parent">
									<a href="localhost/temp1/single-tour.php">Single Tour</a>
								</li>
								<li><a href="#">Layout</a>
									<ul class="sub-menu">
										<li><a href="localhost/temp1/tours-list.php">Tour List</a></li>
										<li><a href="localhost/temp1/tours-2-cols.php">Grid – 2 cols</a></li>
										<li><a href="localhost/temp1/tours.php">Grid – 3 cols(width sidebar)</a></li>
										<li><a href="localhost/temp1/tours-3-cols.php">Grid – 3 cols (no sidebar)</a></li>
										<li><a href="localhost/temp1/tours-4-cols.php">Grid – 4 cols</a></li>
									</ul>
								</li>
							</ul>
						</li>

						<li><a href="localhost/temp1/destinations.php">Destinations</a></li><li><a href="blog.php">Blog</a></li>
						...
						<li class="menu-item-has-children">
							...
							<ul class="sub-menu">
								...
								<li><a href="localhost/temp1/gallery.php">Gallery</a></li>
								<li><a href="localhost/temp1/travel-tips.php">Travel Tips</a></li>
								<li><a href="localhost/temp1/typography.php">Typography</a></li><li><a href="checkout.php">Checkout</a></li>
							</ul>
						</li>
						<li><a href="localhost/temp1/contact.php">Contact</a></li>
						<li class="menu-right">
							<ul>
			...
			<div class="banner-wrapper container article_heading">
				<div class="breadcrumbs-wrapper">
					<ul class="phys-breadcrumb">
						<li><a href="localhost/temp1/index-2.php" class="home">Home</a></li>
						<li><a href="localhost/temp1/blog.php">Business</a></li>
						...
						<div class="images images_single_left">
							...
							<div class="tour_after_title">
								...
								<div class="meta_values">
									<span>Category:</span>
									<div class="value">
										<a href="localhost/temp1/tours.php" rel="tag">Escorted Tour</a>,
										<a href="localhost/temp1/tours.php" rel="tag">Rail Tour</a>
									</div>
								</div>
							...
							<div id="slider" class="flexslider">
								<ul class="slides">
									<li>
										<a href="localhost/temp1/images/tour/tour-1.jpg" class="swipebox" title=""><img width="950" height="700" src="localhost/temp1/images/tour/tour-1.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
										<a href="localhost/temp1/images/tour/tour-2.jpg" class="swipebox" title=""><img width="950" height="700" src="localhost/temp1/images/tour/tour-2.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
										<a href="localhost/temp1/images/tour/tour-3.jpg" class="swipebox" title=""><img width="950" height="700" src="localhost/temp1/images/tour/tour-3.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
										<a href="localhost/temp1/images/tour/tour-4.jpg" class="swipebox" title=""><img width="950" height="700" src="localhost/temp1/images/tour/tour-4.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
										<a href="localhost/temp1/images/tour/tour-5.jpg" class="swipebox" title=""><img width="950" height="700" src="localhost/temp1/images/tour/tour-5.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
									<li>
										<a href="localhost/temp1/images/tour/tour-6.jpg" class="swipebox" title=""><img width="950" height="700" src="localhost/temp1/images/tour/tour-6.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
								</ul>
							</div>
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
									<li>
										<img width="150" height="100" src="localhost/temp1/images/tour/tour-1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
										<img width="150" height="100" src="localhost/temp1/images/tour/tour-2.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
										<img width="150" height="100" src="localhost/temp1/images/tour/tour-3.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
										<img width="150" height="100" src="localhost/temp1/images/tour/tour-4.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
										<img width="150" height="100" src="localhost/temp1/images/tour/tour-5.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
									<li>
										<img width="150" height="100" src="localhost/temp1/images/tour/tour-6.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
								</ul>
							</div>
							<div class="clear"></div>
												...
												<ol class="commentlist">
													<li itemscope="" itemtype="http://schema.org/Review" class="comment byuser comment-author-physcode bypostauthor even thread-even depth-1" id="li-comment-62">
														<div id="comment-62" class="comment_container">
															<img alt="" src="localhost/temp1/images/avata.jpg" class="avatar avatar-60 photo" height="60" width="60">
									...
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											<div class="post_images">
												<a href="localhost/temp1/single-tour.php">
													<span class="price">$93.00</span>
													<img width="430" height="305" src="localhost/temp1/images/tour/430x305/tour-1.jpg" alt="Discover Brazil" title="Discover Brazil">
												</a>
												<div class="group-icon">
													<a href="localhost/temp1/tours.php" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Escorted Tour"><i class="flaticon-airplane-4"></i></a>
													<a href="localhost/temp1/tours.php" data-toggle="tooltip" data-placement="top" title="" data-original-title="Rail Tour"><i class="flaticon-cart-1"></i></a>
												</div>
											</div>
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="localhost/temp1/single-tour.php" rel="bookmark">Discover Brazil</a>
												</h4></div>
										...
										<div class="item_border item-product">
											...
											<span class="price"><del>$87.00</del>
												<ins>$82.00</ins>
													...
													<img width="430" height="305" src="localhost/temp1/images/tour/430x305/tour-2.jpg" alt="Discover Brazil" title="Discover Brazil">
												</a>
												<div class="group-icon">
													<a href="localhost/temp1/tours.php" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
													<a href="localhost/temp1/tours.php" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wildlife"><i class="flaticon-island"></i></a>
												</div>
											</div>
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="localhost/temp1/single-tour.php" rel="bookmark">Kiwiana Panorama</a>
												</h4></div>
												<span class="post_date">5 DAYS 4 NIGHTS</span>
												<div class="description">
													<p>Aliquam lacus nisl, viverra convallis sit amet&nbsp;penatibus nunc&nbsp;luctus</p>
											...
											<div class="read_more">
												...
												<a rel="nofollow" href="localhost/temp1/single-tour.php" class="button product_type_tour_phys add_to_cart_button">Read more</a>
											</div>
										</div>
									</li>
									<li class="item-tour col-md-4 col-sm-6 product">
										<div class="item_border item-product">
											<div class="post_images">
												<a href="localhost/temp1/single-tour.php">
													...
													<img width="430" height="305" src="localhost/temp1/images/tour/430x305/tour-3.jpg" alt="Discover Brazil" title="Discover Brazil">
												</a>
												<div class="group-icon">
													<a href="localhost/temp1/tours.php" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Escorted Tour"><i class="flaticon-airplane-4"></i></a>
													<a href="localhost/temp1/tours.php" data-toggle="tooltip" data-placement="top" title="" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
												</div>
											</div>
											<div class="wrapper_content">
												<div class="post_title"><h4>
													<a href="localhost/temp1/single-tour.php" rel="bookmark">Anchorage to Quito</a>
												</h4></div>
												<span class="post_date">5 DAYS 4 NIGHTS</span>
												<div class="description">
													<p>Aliquam lacus nisl, viverra convallis sit amet&nbsp;penatibus nunc&nbsp;luctus</p>
									...
									<aside class="widget widget_travel_tour">
										<div class="wrapper-special-tours">
											<div class="inner-special-tours">
												<a href="localhost/temp1/single-tour.php">
													<img width="430" height="305" src="localhost/temp1/images/tour/430x305/tour-1.jpg" alt="Discover Brazil" title="Discover Brazil"></a>
												<div class="item_rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
											...
											<div class="inner-special-tours">
												<a href="localhost/temp1/single-tour.php">
													<span class="onsale">Sale!</span>
													<img width="430" height="305" src="localhost/temp1/images/tour/430x305/tour-2.jpg" alt="Discover Brazil" title="Discover Brazil"></a>
												<div class="item_rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
			...
			<div class="container">
				<div class="row">
					...
					<aside class="col-sm-3 custom-instagram widget_text">
						...
						<ul>
							<li><img src="localhost/temp1/images/instagram/1.jpg" alt="instagram"></li>
							<li><img src="localhost/temp1/images/instagram/2.jpg" alt="instagram"></li>
							<li><img src="localhost/temp1/images/instagram/3.jpg" alt="instagram"></li>
							<li><img src="localhost/temp1/images/instagram/4.jpg" alt="instagram"></li>
							<li><img src="localhost/temp1/images/instagram/5.jpg" alt="instagram"></li>
							<li><img src="localhost/temp1/images/instagram/6.jpg" alt="instagram"></li>
						</ul>
					</aside>
				</div>
			</div>
	...
	<div class="wrapper-subscribe" style="background-image: url(localhost/temp1/images/home/bg_newletter.jpg)">
...
<!--end coppyright-->
<script type='text/javascript' src='localhost/temp1/assets/js/jquery.min.js'></script>
<script type='text/javascript' src='localhost/temp1/assets/js/bootstrap.min.js'></script>
<script type='text/javascript' src='localhost/temp1/assets/js/vendors.js'></script>
<script type='text/javascript' src='localhost/temp1/assets/js/jquery.swipebox.min.js'></script>
<script type='text/javascript' src='localhost/temp1/assets/js/theme.js'></script>
<script type='text/javascript' src='localhost/temp1/https://maps.googleapis.com/maps/api/js?key=AIzaSyCaQjbVDR1vRh2iS_V3jLBXRrkQxmoxycQ'></script>
<script type='text/javascript' src='localhost/temp1/assets/js/gmap.js'></script>
</body>

<!-- Mirrored from html.physcode.com/travel/single-tour.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 18:46:21 GMT -->
</html>