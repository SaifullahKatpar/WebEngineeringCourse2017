...
<!-- Mirrored from html.physcode.com/travel/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 18:52:15 GMT -->
<head>
...
<div class="wrapper-container">
		...
		<div class="navigation-menu">
			<div class="container">
				...
				<div class="width-logo sm-logo">
					<a href="index-2.html" title="Travel" rel="home">
	...
	<div class="site wrapper-content">
		<div class="top_site_main" style="background-image:url(http://placehold.it/1400x180);">
						...
						<div class="post_list_inner_content_unit">
							<div class="post_list_item_excerpt">
								...
								<dl>
									...
									<dt>Do It Live</dt>
									<dd>I’ll let Bill O’Reilly will
										<a title="We'll Do It Live" href="https://www.youtube.com/watch?v=O_HyZ5aW76c">explain</a> this one.
									</dd>
								</dl>
								...
								<h2>HTML Tags</h2>
								<p>These supported tags come from the  code
									<a title="Code" href="http://en.support.wordpress.com/code/">FAQ</a>.</p>
								...
								<p>These tests are a <big>big</big> deal, but this tag is no longer supported in HTML5.
								</p>
								<p><strong>Cite Tag</strong></p>
								<p>“Code is poetry.” —<cite>Automattic</cite></p>
								<p><strong>Code Tag</strong></p>
								<p>You will learn later on in these tests that
									<code>word-wrap: break-word;</code> will be your best friend.</p>
...
<pre>.post-title {
	...
	and here's a line of some really, really, really, really long text, just to see how the PRE tag handles it and to find out how it overflows;
								...
								<p>This tag shows <span style="text-decoration:line-through;">strike-through text</span>
								</p>
								...
								<p>Still sticking with science and Isaac Newton’s E = MC<sup>2</sup>, which should lift the 2 up.
								</p>
								<p><strong>Teletype Tag&nbsp;<strong>(<em>deprecated in HTML5</em>)</strong></strong>
								</p>
					...
					<div class="widget-area col-sm-3 align-left">
						...
						<aside class="widget widget_text">
							<img src="http://placehold.it/260x330" alt="">
						</aside>
						<aside class="widget widget_text">
							<img src="http://placehold.it/260x290" alt="">
						</aside>
					</div>
				</div>
			</div>
