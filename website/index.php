...
<!-- Mirrored from html.physcode.com/travel/home-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 18:42:47 GMT -->
<head>
...
<div class="wrapper-container">
		...
		<div class="navigation-menu">
			<div class="container">
				...
				<div class="width-logo sm-logo">
					<a href="index-2.php" title="Travel" rel="home">
					...
					<ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
						...
						<li class="menu-item-has-children">
							...
							<ul class="sub-menu">
								...
								<li><a href="typography.php">Typography</a></li><li><a href="checkout.php">Checkout</a></li>
							</ul>
						</li>
						-->
	...
	<div class="site wrapper-content">
		<div class="home-content" role="main">
			<div class="section-background" style="background-image:url('images/home/gorakh.jpg'); min-height: 100vh;position: relative;">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="banner-typed"><h2 class="phys-typingEffect" style="color:#ffffff">
									Explore new 
									<span class="phys-typingTextEffect" data-strings0="Historical Sites." data-strings1="Landscapes." data-strings2="Places You Never Knew." data-strings3="Travel Pursuits." data-type-speed="100">Destinations.</span>
								</h2>
				...
				<div class="row banner-tour-booking">
					<div class="col-sm-12">
  						<div class="hotel-booking-search travel-booking-search travel-booking-style_2">
							<form name="hb-search-form" action="http://html.physcode.com/travel/tours.php" id="tourBookingForm" method="GET">
								<ul class="hb-form-table">
									...
									<li class="hb-form-field">
										<div class="hb-form-field-select">
											<label>Where</label><select name="tourtax[pa_destination]">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="shortcode_title shortcode-title-style_2">
								<h2 class="title_primary">Tour Deals and Discounts</h2>
								<div class="title_subtitle">
									<a href="tours.php">View All Discount Tours</a>
								</div>
							</div>
										...
										<div class="item_border ">
											<div class="item_content">
												<div class="post_images">
													<a href="single-tour.php" class="woocommerce-LoopProduct-link">
			...
			<div style="background-image:url('images/home/bg-destination.jpg')" class="section-background padding-top-6x padding-bottom-6x">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<div class="shortcode_title max-width-500 shortcode-title-style_2">
								<h2 class="title_primary">Popular Destinations</h2>
								<div class="title_subtitle">Sagittis vulputate magna sagittí sagittis etat feugiat nullam cubilia amet dignisim Euismod</div>
							</div>
							<div class="row wrapper-tours-slider wrapper-tours-type-slider">
								<div class="tours-type-pain">
									<div class="tours_type_item width2x3">
										<a href="destinations.php" title="Sukkur" class="tours-type__item__image">
											<img src="images/tour/sukkur/suk_barrage.jpg" alt="Brazil">
										</a>
										<div class="content-item">
											<div class="item__title">Sukkur</div>
											<div class="count-attr">7 Tours</div>
										</div>
									</div>
									<div class="tours_type_item">
										<a href="destinations.php" title="Canada" class="tours-type__item__image">
											<img src="images/home/ottawa-canada-370x370.jpg" alt="Canada">
										</a>
										<div class="content-item">
											<div class="item__title">Canada</div>
											<div class="count-attr">4 Tours</div>
										</div>
									</div>
									<div class="tours_type_item">
										<a href="destinations.php" title="Cuba" class="tours-type__item__image">
											<img src="images/home/cuba-old-havana-370x370.jpg" alt="Cuba">
										</a>
										<div class="content-item" style="color:#ffffff">
											<div class="item__title">Cuba</div>
											<div class="count-attr">4 Tours</div>
										</div>
									</div>
									<div class="tours_type_item">
										<a href="destinations.php" title="USA" class="tours-type__item__image">
											<img src="images/home/kennedy_space_center-370x370.jpg" alt="USA">
										</a>
										<div class="content-item">
											<div class="item__title">USA</div>
											<div class="count-attr">8 Tours</div>
										</div>
									</div>
									<div class="tours_type_item">
										<a href="destinations.php" title="Philippines" class="tours-type__item__image">
											<img src="images/home/san_agustin_church_manila-370x370.jpg" alt="Philippines">
										</a>
										<div class="content-item">
				...
				<div class="vc_parallax-inner skrollable skrollable-before" data-bottom-top="top: -50%;" data-top-bottom="top: 0%;" style="height: 150%; background-image: url(_images/home/bg-destination.php); top: -50%;"></div>
			</div>

			<div style="background-image:url('images/home/bg-sale.jpg')" class="section-background padding-top-6x padding-bottom-6x">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<div class="wpb_text_column wpb_content_element border-below">
								<div class="wpb_wrapper">
									<h2 style="text-align: center;">Get up to 20% off on your&nbsp;next travel.</h2>
									<p style="text-align: center;">Choose the package you would like to offer to your clients and send us an inquiry using the contact form.</p>
									<p style="text-align: center;"><a class="btn btn-primary" href="#">Get It Now</a>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="shortcode_title shortcode-title-style_3">
							...
							<div class="title_subtitle">
								<a href="tours.php">View All Tours</a></div>
						</div>
									...
									<div class="item_border ">
										<div class="item_content">
											<div class="post_images">
												...
												<div class="group-icon">
													<a href="tours.php" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Rail Tour"><i class="flaticon-cart-1"></i></a>
													<a href="tours.php" data-toggle="tooltip" data-placement="top" title="" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
												</div>
											</div>
									...
									<div class="item_border ">
										<div class="item_content">
											<div class="post_images">
												...
												<div class="group-icon">
													<a href="tours.php" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
													<a href="tours.php" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tour &amp; Cruise"><i class="flaticon-sand"></i></a>
												</div>
											</div>
			...
			<div style="background-color: #f2f2f2" class="padding-bottom-6x  padding-top-6x">
				<div class="container">
					...
					<!--
						<div class="col-sm-6">
							<h2 class="wpb_heading wpb_video_heading">Discover Gorakh Hill Station</h2>
							<div class="wpb_video_wrapper">
								<div class="video-container">
									<iframe src="video.mp4" width="640" height="360" frameborder="0" title="Experience Fiji (Savasi Island Video Tour) 2015" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
								</div>
							</div>
								...
								<div class="row">
									<div class="post_list_content_unit col-sm-6">
										<div class="img_post feature-image">
											<a href="single.php" class="entry-thumbnail"><img width="150" height="150" src="images/blog/201H-150x150.jpg" class="attachment-thumbnail size-thumbnail wp-post-image" alt=""></a>
										</div>
											...
											<div class="post_list_inner_content_unit">
												...
												<div class="wrapper-meta">
													...
													<div class="post_list_cats">
														<a href="blog.php" rel="category tag">Technology</a>
													</div>
												</div>
												<div class="post_list_item_excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam efficitur egestas risus. Sed eros augue,</div>
											</div>
										</div>
									</div>
									<div class="post_list_content_unit col-sm-6">
										<div class="img_post feature-image">
											<a href="single.php" class="entry-thumbnail"><img width="150" height="150" src="images/blog/176H-150x150.jpg" class="attachment-thumbnail size-thumbnail wp-post-image" alt=""></a>
										</div>
										<div class="post-list-content">
											<div class="post_list_inner_content_unit">
												<h3 class="post_list_title">
													<a href="single.php" rel="bookmark">7 Things You Tell People</a>
												</h3>
												<div class="wrapper-meta">
													<div class="date-time">September 6, 2016</div>
													<div class="post_list_cats">
														<a href="blog.php" rel="category tag">Business</a>,
														<a href="blog.php" rel="category tag">Sports</a>
													</div>
												</div>
												<div class="post_list_item_excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam efficitur egestas risus. Sed eros augue,</div>
											</div>
									...
									<div class="post_list_content_unit col-sm-6">
										<div class="img_post feature-image">
											<a href="single.php" class="entry-thumbnail"><img width="150" height="150" src="images/blog/86H-150x150.jpg" class="attachment-thumbnail size-thumbnail wp-post-image" alt=""></a>
										</div>
										<div class="post-list-content">
											<div class="post_list_inner_content_unit">
												<h3 class="post_list_title">
													<a href="single.php" rel="bookmark">World’s hottest destinations for vegans</a>
												</h3>
												<div class="wrapper-meta">
													<div class="date-time">September 6, 2016</div>
													<div class="post_list_cats">
...
<!-- Mirrored from html.physcode.com/travel/home-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 18:45:44 GMT -->
</html>